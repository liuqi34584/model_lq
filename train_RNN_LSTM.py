...
output_path = './output/rnn_lstm/AF1.pth'
output_log_path = "./output/rnn_lstm/0121.txt"
...
# 模型搭建
# '''
import model_rnn_lstm.Models as models
...
for epoch in range(100):
    ...
    test_acc1, test_sensitivity1, test_specificity1 = 0, 0, 0
    test_acc2, test_sensitivity2, test_specificity2 = 0, 0, 0
