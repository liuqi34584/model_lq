...
#==============================================================加载CPSC2025数据集================================
train_X=h5py.File('other_file/CPSC2025/traindata.mat')
print(train_X.keys())
train_X=train_X['traindata']  # (4000, 20000) 采样率为 400 Hz，信号时间长度 10 s，
train_X = np.array(train_X)
train_X = train_X.T # (20000, 4000)

# 分割数据
CPSC2025_atrial_fibrillation_data = train_X[:500]
CPSC2025_non_atrial_fibrillation_data = train_X[500:1000]
CPSC2025_unlabeled_data = train_X[1000:]
