...
for patient_id in patient_ids:
    ...
    mit_bih_af_path = 'other_file/mit-bih-atrial-fibrillation-database-1.0.0/files/' + patient_id
    ...
    for i in range(0, len(r_peaks_position), 5):
        ...
        one_data = []
        one_data.append(list(MIT_BIH_AF.resample_signal_length(signal, 768)))
